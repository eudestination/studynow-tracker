// Wedding data sync via Supabase — handles photos & venue images
...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    try {
      ...
      if (!rows.length || !rows[0].notes) {
        return res.status(200).json({ version:1, guests:[], expenses:[], tasks:[], tables:[], photos:[], venuePhotos:{}, settings:{spotifyUrl:''} });
      }
